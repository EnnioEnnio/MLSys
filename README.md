...
| :---- | :---- | :---- | :---- | :---- | :---- |
| [all-MiniLM-L6-v2](https://huggingface.co/sentence-transformers/all-MiniLM-L6-v2) | Distilled 6-layer encoder, mean-pool (built-in), 384-dim | 22.7M | 260M | 900 | Most-used model on HF |
...
| [potion-base-8M](https://huggingface.co/minishlab/potion-base-8M) | Static lookup table (model2vec), no attention, ignores word order, 256-dim | 7.56M | 710k | 5 | Extreme low-cost anchor; ~500× faster on CPU |
| [potion-base-32M](https://huggingface.co/minishlab/potion-base-32M) | Static lookup table (model2vec), 512-dim | 32.3M | 84k | 4 | Larger static variant for the cost axis |
| [distilbert-base-uncased](https://huggingface.co/distilbert/distilbert-base-uncased) | 6-layer distilled BERT, mean-pool, 768-dim | 67M | ~25M | ~3k | Distilled BERT; fast CPU baseline |
...
| [modernbert-base](https://huggingface.co/answerdotai/ModernBERT-base) | Modernized BERT (RoPE, local/global attn, 8k ctx), mean-pool, 768-dim | 149M | 1.8M | 1200 | Current-gen encoder, huge finetune tree |
...
| [deberta-v3-base](https://huggingface.co/microsoft/deberta-v3-base) | Disentangled attention + ELECTRA-style objective, mean-pool, 768-dim | 86M | 3M | 600 | Strongest base-size encoder for accuracy |
| [electra-base-discriminator](https://huggingface.co/google/electra-base-discriminator) | Encoder trained as real/fake token detector, mean-pool, 768-dim | 110M | 56M | 70 | Different pretraining game, sample-efficient |
| [albert-base-v2](https://huggingface.co/albert/albert-base-v2) | Cross-layer weight sharing + factorized embeddings, mean-pool, 768-dim | 11.8M | 680k | 260 | Many effective layers, tiny footprint |
...
| [mxbai-embed-large-v1](https://huggingface.co/mixedbread-ai/mxbai-embed-large-v1) | Large contrastive encoder + Matryoshka, 1024-dim | 335M | 5M | 55 | Large Matryoshka data point |
